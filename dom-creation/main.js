...
function renderPokemon(pokemon) {
  ...
  imgPikachu.setAttribute('src', pokemon.imageUrl);
  divPokemonCard.appendChild(imgPikachu);
  ...
  h2Text.textContent = pokemon.name;
  divPokemonCardText.appendChild(h2Text);
  var h3Text = document.createElement('h3');
  h3Text.textContent = '#' + pokemon.number;
  divPokemonCardText.appendChild(h3Text);
  var pText = document.createElement('p');
  pText.textContent = pokemon.description;
  divPokemonCardText.appendChild(pText);
